...
<div class="page-content fade-in-up">
    <div class="card">
        <div class="card-header bgView cardB">
            <div class="row">
                <h4 class="col-md-6 heading_h4">All Category List</h4>
                <div class="col-md-6">
                ...
                <tbody>
                    @foreach ($category as $key=> $row)
                        <tr>
                            ...
                            <td>{{$row->cat_name}}</td>
                            <td>
                                <a href="{{route('edit.category',$row->id)}}" class="badge badge-pill badge-primary"><i class="fa fa-pencil"></i></a>
                                ...
                                <a href="{{route('view.category',$row->id)}}" class="badge badge-pill badge-success"><i class="fa fa-eye"></i></a>
                            </td>
                        </tr> 
                    @endforeach
                </tbody>

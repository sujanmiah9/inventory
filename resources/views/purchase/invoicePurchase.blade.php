...
<div class="page-content fade-in-up">
    <div class="ibox invoice">
            ...
            <div class="row">
                <div class="col-6">
                    <div>
                        ...
                        <li class="m-b-5"><span style="font-weight: bold">Name: {{$supplier->sup_name}}</span> </li>
                            <li class="m-b-5"> <span style="font-weight: bold">Address: </span> {{$supplier->address}}</li>
                            <li class="m-b-5"> <span style="font-weight: bold">Company: </span> {{$supplier->shopName}}</li>
                            <li class="m-b-5"> <span style="font-weight: bold">Phone: </span> {{$supplier->phone}}</li>
                        </ul>
                    </div>
                </div>
                @php
                ...
                <div class="col-6 text-right">
                    <div class="clf" style="margin-bottom:30px;">
                        ...
                        <dd class="col-sm-6">{{$purchase_no}}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="text-right">
            ...
            <button class="btn btn-success ml-3" type="button" data-toggle="modal" data-target="#staticBackdrop"> Purchase</button>
        </div>
    </div>
    <style>
        .invoice {
